...
class PrismCode extends HTMLElement {
  // Observe changes to "code", "language", and "highlight" attributes.
  ...
  disconnectedCallback() {
    // No interval to clear in this version.
  }
  ...
  render() {
    ...
    // The "highlight" attribute specifies which line(s) to highlight (e.g., "3" or "2,4" or "2-4").
    const highlight = this.getAttribute('highlight') || '2';

    // Create the <pre> element and set its data-line attribute.
    const pre = document.createElement('pre');
    pre.setAttribute('data-line', highlight);

    // Create the <code> element, set its class, and add the code.
...
export default HelloWorld;
    `;
        ...
        prismCodeElement.setAttribute('highlight', '4');
